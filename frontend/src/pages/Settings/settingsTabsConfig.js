...
const SETTINGS_SEARCH_METADATA = {
  ...
  indexers: {
    ...
    fields: {
      ...
      "Enable in Psalter": "indexer enabled",
  ...
  "download-clients": {
    ...
    fields: {
      ...
      "Local path": "Psalter path mapping",
  ...
  playback: {
    sections: ["Playback servers", "Scrobbling", "Cover art", "Connection", "Account", "Psalter library path", "Main library (optional)", "Sync"],
    services: {
    ...
    fields: {
      ...
      "Plex Psalter Library path (optional)": "Plex library section path",
