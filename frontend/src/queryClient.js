...
export const queryKeys = {
  ...
  navidromePlaylistsRoot: ["navidrome-playlists"],
  navidromePlaylists: ["navidrome-playlists", "list"],
  navidromePlaylist: (id) => ["navidrome-playlists", "detail", String(id || "")],
  navidromePlaylistStatus: ["navidrome-playlists", "status"],
